package com.olx.productservice.controller;
...
import com.olx.productservice.controller.ProductController;
...
public class ProductControllerTest {
	...
	{
		ProductPojo product=new ProductPojo(null,"abc", "abc", "abc", null, "urmi", "87979789", "kol");
		Mockito.when(productService.updateOldProduct(product)).thenReturn(product);
		ProductPojo product1=productController.updateProduct(product);
		System.out.println(product1);
		Assert.assertNotNull(product1);
	...
	public void updateProductTest_2()
	{
		ProductPojo product=new ProductPojo(null,"abc", "abc", "abc", null, "urmi", "79789", "kol");
		Mockito.when(productService.updateOldProduct(product)).thenReturn(product);
		ProductPojo product1=productController.updateProduct(null);
		Assert.assertNotNull(product1);
